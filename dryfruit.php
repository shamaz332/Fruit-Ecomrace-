...
<body>
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                            ...
                            <li class="nav-item active">
                                <a class="nav-link" id="actives" href="dryfruit.php">Dry Fruit</a>
                            </li>
                            <li class="nav-item">
  ...
  $query = "SELECT * FROM `fruits` where `fruit_type`= 'Dry Fruit'";
  ...
  ?>
   ...
   <?php echo $name; ?>
                        ...
                        <input class=" btn btn--blue" type="submit" name="dry_submit" value="Order Now">
                    </form>
                    </div>
                </div>
            </div>
