    ...
    <section class="content container-fluid">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 ">
                    <form action="update_post.php" method="POST" class="form-horizontal" onsubmit="return validate2();" enctype="multipart/form-data">
                        <div class="form-group">
                            <legend><b>Update Fruit</b></legend>
                        </div>
                        <?php
...
<label>Fruit Id:</label>
    <input type="text" name="id" id="input" class="form-control" required="required" placeholder="Fruit ID">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="heading" id="input" class="form-control" placeholder="Banana">
    ...
    Dry Fruit
                            ...
                            <div class="form-group">
                                <label>Price:</label>
                                <input type="text" name="price" id="price" class="form-control" placeholder="Rs 152/kg">
